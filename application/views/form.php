...
</td><td>Płyta Główna:</td><td><?php print form::select('id_plyta', $plyta, $plyta_selected, array('style' => 'width:300px', 'class' => 'sock_depend')); ?></td><td class="sock_dep_price" id="plyta_cena"></td><td id="plyta_link"></td><td id="plyta_opis"></td><td id="plyta_sklep"><?php print form::select('id_plyta_sklep', NULL, NULL, array('style' => 'width:200px', 'class' => 'sock_depend'),NULL,'standard'); ?></td></tr>
