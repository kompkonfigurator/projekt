...
</td><td>Płyta Główna:</td><td><?php print form::select(array('name' => 'komp_plyta', 'style' => 'width:300px', 'class' => 'sock_depend', 'onchange' => 'zmiana(selectedIndex, \'procesor_cena\', \'procesor\');'),NULL,'standard'); ?></td><td class="sock_dep_price" id="plyta_cena" class="cena"></td><td id="plyta_link"></td><td id="plyta_opis"></td><td id="plyta_sklep"><?php print form::select(array('name' => 'komp_plyta_sklep', 'style' => 'width:200px', 'class' => 'sock_depend', 'onchange' => 'zmiana_shop(selectedIndex, \'plyta_cena\', \'plyta\', komp_plyta.selectedIndex);'),NULL,'standard'); ?></td></tr>
