...
{
$licznik=0;
my $web_source = get( 'http://api.nokaut.pl/?format=rest&key=aa34033cb376ddfaeece2fdb5a18fd5f&method=nokaut.Product.getByCategory&category=150&offset='.$pom.'&sort_direction=title_asc' );
